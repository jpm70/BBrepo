...
# 🧠 Recordatorio opcional para añadir al rc.local
echo -e "\n🧠 Recuerda añadir esto en /etc/rc.local antes del 'exit 0':"
echo "    python3 /opt/canary_server.py &"
echo -e "\n💣 Al abrir /home/mike/bandera13.html, se activará el registro en /var/log/bandera13.log"
